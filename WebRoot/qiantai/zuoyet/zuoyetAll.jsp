  ...
  <div id="main">
      ...
      <div id="site_content">
	      ...
	      <div class="content">
	          ...
	          <div>
		           <c:forEach items="${requestScope.zuoyetList}" var="zuoyet" varStatus="sta">
                        <div class="c1-bline" style="padding:7px 0px;">
	                        <div class="f-left">
	                             <img src="<%=path %>/img/head-mark4.gif" align="middle" class="img-vm" border="0"/> 
	                             <a href="<%=path %>/zuoyetDetailQian.action?id=${zuoyet.id }">${zuoyet.mingcheng }</a>
	                        </div>
	                        <div class="f-right">${zuoyet.fabushi }</div>
	                        <div class="clear"></div>
                        </div>
                   </c:forEach>
	          </div>
